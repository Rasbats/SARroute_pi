 ...
 *
 * Project:  OpenCPN
 * Purpose:  SARroute Plugin Freinds
...
//----------------------------------------------------------------------------------------------------------
//    SARroute Overlay Specification
//----------------------------------------------------------------------------------------------------------

class SARrouteOverlay {
public:
  SARrouteOverlay(void) {
    m_iTexture = 0;
...
//----------------------------------------------------------------------------------------------------------
//    SARroute Overlay Factory Specification
//----------------------------------------------------------------------------------------------------------

class SARrouteUIDialog;

class SARrouteOverlayFactory {
public:
  SARrouteOverlayFactory(SARrouteUIDialog &dlg);
  ~SARrouteOverlayFactory();
 ...
 */
  ...
  void DrawGLLabels(SARrouteOverlayFactory *pof, wxDC *dc, PlugIn_ViewPort *vp,
