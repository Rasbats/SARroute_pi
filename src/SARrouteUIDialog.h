 ...
 *
 * Project:  OpenCPN
 * Purpose:  SARroute Plugin Friends
...
#ifndef __SARrouteUIDIALOG_H__
#define __SARrouteUIDIALOG_H__
...
class SARrouteUIDialog : public SARrouteUIDialogBase {
public:
  SARrouteUIDialog(wxWindow* parent, SARroute_pi* ppi);
  ~SARrouteUIDialog();
