...
///////////////////////////////////////////////////////////////////////////////
/// Class SARrouteUIDialogBase
///////////////////////////////////////////////////////////////////////////////
class SARrouteUIDialogBase : public wxFrame
{
	private:
	...
	public:
		...
		SARrouteUIDialogBase( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = _("Finland SAR"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( -1,-1 ), long style = wxCAPTION|wxCLOSE_BOX|wxFRAME_FLOAT_ON_PARENT|wxRESIZE_BORDER|wxSYSTEM_MENU|wxTAB_TRAVERSAL );

		~SARrouteUIDialogBase();
